...
__addon__ = Addon(id='plugin.video.fenjr')
...
navigator_db = translatePath('special://profile/addon_data/plugin.video.fenjr/navigator.db')
watched_db = translatePath('special://profile/addon_data/plugin.video.fenjr/watched.db')
favorites_db = translatePath('special://profile/addon_data/plugin.video.fenjr/favourites.db')
views_db = translatePath('special://profile/addon_data/plugin.video.fenjr/views.db')
trakt_db = translatePath('special://profile/addon_data/plugin.video.fenjr/traktcache4.db')
maincache_db = translatePath('special://profile/addon_data/plugin.video.fenjr/maincache.db')
metacache_db = translatePath('special://profile/addon_data/plugin.video.fenjr/metacache.db')
debridcache_db = translatePath('special://profile/addon_data/plugin.video.fenjr/debridcache.db')
external_db = translatePath('special://profile/addon_data/plugin.video.fenjr/providerscache2.db')
databases_path = translatePath('special://profile/addon_data/plugin.video.fenjr')
...
def addon(addon_id='plugin.video.fenjr'):
...
def notification(line1, time=5000, icon=None, sound=False):
	...
	icon = icon or translate_path('special://home/addons/plugin.video.fenjr/icon.png')
...
def choose_view(view_type, content):
	...
	settings_icon = translate_path('special://home/addons/plugin.video.fenjr/resources/media/settings.png')
	fanart = translate_path('special://home/addons/plugin.video.fenjr/fanart.png')
...
def build_url(url_params):
	return ''.join(['plugin://plugin.video.fenjr/?', urlencode(url_params)])

def add_dir(url_params, list_name, __handle__, iconImage='DefaultFolder.png', fanartImage=None, isFolder=True):
	fanart = fanartImage or translate_path('special://home/addons/plugin.video.fenjr/fanart.png')
	icon = translate_path('special://home/addons/plugin.video.fenjr/resources/media/%s' % iconImage)
