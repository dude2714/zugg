...
def skin_location():
	return translate_path('special://home/addons/plugin.video.fenjr')
...
def external_scraper_module():
	...
	value_map = {
		...
		'Magneto': 'script.module.magneto'
	}
	addon_id = value_map.get(addon_id, addon_id)
	if addon_id:
		addon_id = addon_id.strip().lower()
	if addon_id in ('script.module.fenomscrapers', 'script.module.cocoscrapers', 'script.module.viperscrapers', 'script.module.magneto'):
		return addon_id
...
def tmdb_api_key():
	return get_setting('tmdb_api', 'a07324c669cac4d96789197134ce272b')
