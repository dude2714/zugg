...
icon_directory, fanart = 'special://home/addons/plugin.video.fenjr/resources/media/%s', tp('special://home/addons/plugin.video.fenjr/fanart.png')
...
class Navigator:
	...
	def premium(self):
		...
		furk_str, easy_str, rd_str, pm_str = ls(32069), ls(32070), ls(32054), ls(32061)
...
#		fen_str, fenom_scr_str, myaccounts_str = ls(32036), ls(32522), ls(33025)
		fen_str, fenom_scr_str = 'Fen Jr', 'Scrapers'
...
#		fen_str, cl_str, fs_str, ma_str, lut_str, k_str = ls(32036), ls(32508), ls(32522), ls(33025), ls(32777), ls(32538)
		fen_str, cl_str, fs_str, lut_str, k_str = 'Fen Jr', ls(32508), 'Scrapers', ls(32777), ls(32538)
...
#		sc_v, ma_v = addon('script.module.fenomscrapers').getAddonInfo('version'), addon('script.module.myaccounts').getAddonInfo('version')
		...
		mt_str, mh_str = tp(log_path % 'plugin.video.fenjr'), '[B]%s[/B]: %s  [I](v.%s)[/I]' % (cl_str.upper(), fen_str, fen_vstr)
...
#		self.AD({'mode': 'show_text', 'heading': mah_str, 'file': mat_str, 'exclude_external': 'true'}, mah_str, 'lists.png', False)
	...
	def multiselect_genres(self):
		...
		icon_directory = 'special://home/addons/plugin.video.fenjr/resources/media/'
	...
	def tips(self):
		tips_location = 'special://home/addons/plugin.video.fenjr/resources/text/tips'
