...
class YesNoProgressMedia(BaseDialog):
	...
	def make_items(self):
		...
		self.poster = self.meta.get(self.poster_main) or self.meta.get(self.poster_backup) or translate_path('special://home/addons/plugin.video.fen/resources/media/box_office.png')
