...
navigator_db = translatePath('special://profile/addon_data/plugin.video.fen/navigator.db')
watched_db = translatePath('special://profile/addon_data/plugin.video.fen/watched.db')
favorites_db = translatePath('special://profile/addon_data/plugin.video.fen/favourites.db')
views_db = translatePath('special://profile/addon_data/plugin.video.fen/views.db')
trakt_db = translatePath('special://profile/addon_data/plugin.video.fen/traktcache4.db')
maincache_db = translatePath('special://profile/addon_data/plugin.video.fen/maincache.db')
metacache_db = translatePath('special://profile/addon_data/plugin.video.fen/metacache.db')
debridcache_db = translatePath('special://profile/addon_data/plugin.video.fen/debridcache.db')
external_db = translatePath('special://profile/addon_data/plugin.video.fen/providerscache2.db')
databases_path = translatePath('special://profile/addon_data/plugin.video.fen')
...
def choose_view(view_type, content):
	...
	settings_icon = translate_path('special://home/addons/plugin.video.fen/resources/media/settings.png')
...
def build_url(url_params):
	return ''.join(['plugin://plugin.video.fen/?', urlencode(url_params)])

def add_dir(url_params, list_name, __handle__, iconImage='DefaultFolder.png', fanartImage=None, isFolder=True):
	fanart = fanartImage or translate_path('special://home/addons/plugin.video.fen/fanart.png')
	icon = translate_path('special://home/addons/plugin.video.fen/resources/media/%s' % iconImage)
