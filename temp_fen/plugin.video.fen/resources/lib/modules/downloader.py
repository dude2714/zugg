...
levels =['../../../..', '../../..', '../..', '..']
poster_empty = kodi_utils.translate_path('special://home/addons/plugin.video.fen/resources/media/box_office.png')
...
def runner(params):
	...
	if action == 'meta.single': Downloader(params).run()
		...
		default_icon = kodi_utils.translate_path('special://home/addons/plugin.video.fen/resources/media/%s' % icon)
