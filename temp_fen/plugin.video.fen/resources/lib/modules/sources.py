...
class Sources():
	...
	def furkPacks(self, name, file_id, highlight=None, download=False):
		...
		default_furk_icon = translate_path('special://home/addons/plugin.video.fen/resources/media/furk.png')
	...
	def debridPacks(self, debrid_provider, name, magnet_url, info_hash, highlight=None, download=False):
		...
		default_debrid_icon = translate_path('special://home/addons/plugin.video.fen/resources/media/%s' % icon)
