...
icon_directory, fanart = 'special://home/addons/plugin.video.fen/resources/media/%s', tp('special://home/addons/plugin.video.fen/fanart.png')
...
#		self.AD({'mode': 'show_text', 'heading': mah_str, 'file': mat_str, 'exclude_external': 'true'}, mah_str, 'lists.png', False)
	...
	def multiselect_genres(self):
		...
		icon_directory = 'special://home/addons/plugin.video.fen/resources/media/'
