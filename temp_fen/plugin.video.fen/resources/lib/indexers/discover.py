...
icon_directory = 'special://home/addons/plugin.video.fen/resources/media/%s'
default_icon = kodi_utils.translate_path('special://home/addons/plugin.video.fen/resources/media/discover.png')
...
class Discover:
	...
	def similar_recommended(self):
		...
		for item in results:
			...
			else: icon = kodi_utils.translate_path('special://home/addons/plugin.video.fen/resources/media/box_office.png')
	...
	def cast(self):
		...
		if len(result) > 1:
			for item in result:
				...
				else: icon = kodi_utils.translate_path('special://home/addons/plugin.video.fen/resources/media/genre_family.png')
	...
	def help(self):
		text_file = kodi_utils.translate_path('special://home/addons/plugin.video.fen/resources/text/tips/135. Fen Discover.txt')
	...
	def _build_url(self, query):
		return ''.join(['plugin://plugin.video.fen/?', urlencode(query)])
