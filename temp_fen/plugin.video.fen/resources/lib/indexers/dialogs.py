...
def trakt_manager_choice(params):
	...
	icon = params.get('icon', None) or translate_path('special://home/addons/plugin.video.fen/resources/media/trakt.png')
...
def extras_lists_choice():
	screenshots_directory = 'special://home/addons/plugin.video.fen/resources/media/screenshots/extras/%s'
...
def results_layout_choice():
	screenshots_directory = 'special://home/addons/plugin.video.fen/resources/media/screenshots/results/%s'
	xml_choices = [
