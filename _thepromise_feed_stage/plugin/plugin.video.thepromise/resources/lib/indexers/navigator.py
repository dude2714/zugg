...
class navigator:
    ...
    def root(self):
        ...
        downloads = control.setting('downloads') == 'true' and (
            self._has_download_items(control.setting('movie.download.path')) or
            self._has_download_items(control.setting('tv.download.path'))
        )
        if downloads == True:
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem('TV Shows 24/7', 'watchonline_menu', 'channels.png', 'DefaultTVShows.png')
