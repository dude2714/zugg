...
def trakt_manager_choice(params):
	...
	icon = params.get('icon', None) or translate_path('special://home/addons/plugin.video.fenjr/resources/media/trakt.png')
...
def extras_lists_choice():
	screenshots_directory = 'special://home/addons/plugin.video.fenjr/resources/media/screenshots/extras/%s'
...
def results_layout_choice():
	screenshots_directory = 'special://home/addons/plugin.video.fenjr/resources/media/screenshots/results/%s'
	xml_choices = [
...
def options_menu(params, meta=None):
	...
	results_sorting_status = get_setting('results.sort_order_display').replace('$ADDON[plugin.video.fenjr 32582]', ls(32582))
