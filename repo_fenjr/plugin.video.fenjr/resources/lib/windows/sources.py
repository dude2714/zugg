...
media_folder = 'special://home/addons/plugin.video.fenjr/resources/skins/Default/media/%s'
info_icons_dict = {'furk': translate_path(media_folder % 'providers/furk.png'),
					...
					'torbox': translate_path(media_folder % 'providers/premiumize.png'),
...
backup_poster = translate_path('special://home/addons/plugin.video.fenjr/resources/media/box_office.png')
backup_fanart = translate_path('special://home/addons/plugin.video.fenjr/fanart.png')
string = str
upper = string.upper
lower = string.lower
...
class SourceResults(BaseDialog):
	...
	def get_provider_and_path(self, provider):
		...
		else: provider, provider_path = 'folders', translate_path('special://home/addons/plugin.video.fenjr/resources/skins/Default/media/providers/folders.png')
...
class ResultsInfo(BaseDialog):
	...
	def get_provider_and_path(self):
		...
		if provider in info_icons_dict: provider_path = info_icons_dict[provider]
		else: provider_path = translate_path('special://home/addons/plugin.video.fenjr/resources/skins/Default/media/providers/folders.png')
		return provider, provider_path
