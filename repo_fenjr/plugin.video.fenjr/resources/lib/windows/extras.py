...
backup_thumbnail = translate_path('special://home/addons/plugin.video.fenjr/resources/media/box_office.png')
backup_cast_thumbnail = translate_path('special://home/addons/plugin.video.fenjr/resources/media/genre_family.png')
		...
		if action in self.context_actions:
			...
			if focus_id == playbrowse_id and self.media_type == 'movie':
				...
				params = {'action': 'image', 'name': '%s %s' % (self.rootname, chosen_listitem.getProperty('tikiskins.extras.name')),
						...
						'media_type': 'image', 'image': translate_path('special://home/addons/plugin.video.fenjr/icon.png')}
		...
		def builder():
			for item in data:
				try:
					...
					icon = translate_path('special://home/addons/plugin.video.fenjr/resources/media/%s' % parentsguide_inputs[item['title']][1])
